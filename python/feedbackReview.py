...
# is displayed as a one-line string, and if it's too long there's no way to see what 
# it is about. Naturally, this horrible bug should be fixed. Implement a function that, 
# given a feedback and the size of the screen, splits the feedback into lines so that:
...
# program starts here, methods are defined above
	...
	print("given string-This is an example feedback-, with x=8 returns ", solution("This is an example feedback",8))
